...
csv_name = [
    "KG_basic_gene_KeggGO_Dec19_2024.csv",
    "KG_gene2transcrpit_Dec19.csv",
    "KG_OE_Mut_WOS_PUBMED_RAPDB_traitGene.csv",
    "KG_transcrpit2protein_Dec19.csv",
]
...
def write2txt(file_name, content, type_):
    """
    Writes either a set or a list of triples to file_name.

    :param file_name: Output text file name
    :param content:   The actual data (set/list)
    :param type_:     "set" or "list"
    """
    if type_ == "set":
        with open(file_name, "w", encoding="utf-8") as file:
            for idx, item in enumerate(content, start=0):
